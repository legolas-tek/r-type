...
public:
    ...
    void initScene(engine::Registry &reg) override
    {
        ...
        reg.get_components<Component::Position>().insert_at(
            background, std::move(Component::Position(0, 0, 0))
        );
        // midground
        reg.get_components<Component::Position>().insert_at(
            midground, std::move(Component::Position(0, 0, 0))
        );
        // foreground
        reg.get_components<Component::Position>().insert_at(
            foreground, std::move(Component::Position(0, 0, 0))
        );
        // player
        reg.get_components<Component::Position>().insert_at(
            scarfy, std::move(Component::Position(100, 100, 0))
        );
