...
public:
     ...
     */
    Animation(
        size_t textureWidth, size_t textureHeight, size_t entityWidth,
        size_t entityHeight, size_t offset, size_t duration
    )
    ...
    size_t _entityWidth = 0;
    size_t _entityHeight = 0;
